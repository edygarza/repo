<div class="tips index">
	...
	<tr>
		...
		<td><?php echo h($tip['Tip']['content']); ?>&nbsp;</td>
		<td><?php echo h($tip['Tip']['user_name']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $tip['Tip']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $tip['Tip']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $tip['Tip']['id']), null, __('Are you sure you want to delete # %s?', $tip['Tip']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
